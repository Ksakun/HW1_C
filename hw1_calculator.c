...
/*
 * @brief Start calculator & set memory  
 */
...
/*
 * @brief Destroy calculator & Free memory
 * @param hw1_caculator_t *calculator
 */
...
/*
 * @brief Get 'plus' count number
 * @param hw1_caclulator_t *calculator
 * @return int count
 * @return error
 */
...
/*
 * @brief Get data from calculator  
 * @param hw1_calculator_t *calculator
...
/*
 * @brief Data process in calculator
 * @param hw1_calculator *calculator
 * @parma int data
 * @return int data | error
 */
